...
/**
 * Monoline Georgian front door — thin white hairlines, no fills, with a warm
 * radial glow bleeding through the fanlight (F4C99A → F26B1F → transparent).
 */
export default function GeorgianDoor({ className }: { className?: string }) {
  ...
  const faint = { ...stroke, stroke: "rgba(255,255,255,0.42)" };
  ...
  return (
    ...
    >
      <defs>
        <radialGradient id="fanGlow" cx="50%" cy="40%" r="60%">
          <stop offset="0%" stopColor="#F4C99A" stopOpacity="0.9" />
          <stop offset="45%" stopColor="#F26B1F" stopOpacity="0.4" />
          <stop offset="100%" stopColor="#F26B1F" stopOpacity="0" />
        </radialGradient>
      </defs>

      {/* warm glow through the fanlight */}
      <ellipse cx="150" cy="150" rx="175" ry="225" fill="url(#fanGlow)" />
      ...
      <path d="M52 150 A98 98 0 0 1 248 150 L248 462 L52 462 Z" {...stroke} />
      <path d="M66 156 A84 84 0 0 1 234 156 L234 452 L66 452 Z" {...faint} />
